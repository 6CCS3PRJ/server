...
function getPatchRoutes() {
  const router = express.Router()
  router.patch("/reloadFeatureCache", reloadFeatureCache)
  router.patch("/reloadHeatmapData", reloadHeatmapData)
  return router
}

/**
 * Reload the cached features by computing number of hotspots per GEOJson feature
 * @route PATCH /wifis/patch/reloadFeatureCache
 ...
 * @route PATCH /wifis/patch/reloadHeatmapData
 * @group wifis - Operations about Wireless Access Points
 * @returns {Response.model} 200 - Success
 */
